...
import './focus.template.dart' as i4;
...
const <dynamic>[],
const [const <dynamic>[ManagedZone], const <dynamic>[String, const Attribute('role')]],
(ManagedZone _managedZone, String role) => new FocusListDirective(_managedZone, role),
