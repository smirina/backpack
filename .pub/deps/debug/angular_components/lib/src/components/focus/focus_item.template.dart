...
import './focus.template.dart' as i2;
...
const <dynamic>[],
const [const <dynamic>[ElementRef], const <dynamic>[String, const Attribute('role')]],
(ElementRef element, String role) => new FocusItemDirective(element, role),
