...
(BaseMaterialInput input, NgControl control) => new MaterialInputDefaultValueAccessor(input, control),
const <dynamic>[ControlValueAccessor, OnDestroy])
)
..registerType(MaterialInputBlurValueAccessor, new _ngRef.ReflectionInfo(
const <dynamic>[],
const [const <dynamic>[BaseMaterialInput], const <dynamic>[NgControl, const Self(), const Optional()]],
(BaseMaterialInput input, NgControl control) => new MaterialInputBlurValueAccessor(input, control),
const <dynamic>[ControlValueAccessor, OnDestroy])
)
;
i0.initReflector();
