...
library angular_components.laminate.overlay.module.template.dart;
...
import 'src/overlay_dom_service.template.dart' as i7;
import 'src/overlay_service.template.dart' as i8;
import 'src/render/overlay_dom_render_service.template.dart' as i9;
import 'src/render/overlay_style_config.template.dart' as i10;
export 'module.dart';
...
const [const <dynamic>[String, const Inject(overlayContainerName)], const <dynamic>[HtmlElement, const Inject(overlayContainerParent)], const <dynamic>[const Optional(), const SkipSelf(), const Inject(overlayContainerToken)]])
)
..registerFunction(getDefaultContainerName, new _ngRef.ReflectionInfo(
const <dynamic>[const Injectable()],
const [const <dynamic>[const Optional(), const SkipSelf(), const Inject(overlayContainerName)]])
)
...
const <dynamic>[const Injectable()],
const [const <dynamic>[Document], const <dynamic>[const Optional(), const SkipSelf(), const Inject(overlayContainerParent)]])
)
;
i0.initReflector();
i1.initReflector();
